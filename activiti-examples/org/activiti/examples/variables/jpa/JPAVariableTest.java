...
//	ProcessEngineConfiguration processEngineConfiguration = ((ProcessEngineImpl) activitiRule.getProcessEngine()).getProcessEngineConfiguration();
...
//  }
  ...
  private void assertTextPresent(String expectedTextPresent, String actual) {
	  assertTrue(actual.indexOf(expectedTextPresent) > -1);
  }
}
